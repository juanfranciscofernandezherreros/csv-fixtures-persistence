...
`FixtureKey` y `FixtureValue` se consumen desde `com.fernandez.basketball:basketball-event-contracts:1.0.2`. Este repositorio ya no mantiene copias locales de los schemas ni genera las clases Avro durante su propia build.
