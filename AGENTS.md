...
## Flujo obligatorio
Partir de `main` actualizado; crear rama dedicada; aplicar el incremento a `revision`; actualizar CHANGELOG y README cuando corresponda; ejecutar tests/checks; abrir PR; no fusionar sin autorización explícita; con merge automático autorizado, fusionar solo con checks verdes.
...
- DEV, INT y QA promocionan el mismo artefacto.
